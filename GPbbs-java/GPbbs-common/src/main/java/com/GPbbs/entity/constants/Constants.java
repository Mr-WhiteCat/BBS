package com.GPbbs.entity.constants;

public class Constants {
    public static final Integer POINTS_5 = 5;
    ...
    public static final String VERIFICATION_CODE_KEY_EMAIL = "verification_code_key_email";
