...
public interface UserMessageMapper<T,P> extends BaseMapper<T,P> {
	 ...
	 * 更新用户消息状态
	 */
	void updateMessageStatusBatch(@Param("messageIds") String[] messageIds, @Param("receivedUserId") String receivedUserId, @Param("messageType") Integer messageType, @Param("status") Integer status);
