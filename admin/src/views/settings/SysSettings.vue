<template>
  <div>
    ...
    >
      ...
      <el-row>
        <el-col :span="12"
          ><el-form-item label="发帖积分" prop="postPoints">
            <el-input
              v-model="formData.postPoints"
              placeholder="请输入发帖可以获得的积分"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="每天可发贴数量" prop="postDayCountThreshold">
            <el-input
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="评论积分" prop="commentPoints">
            <el-input
              v-model="formData.commentPoints"
