<template>
  ...
  >
        ...
        <div class="user-extend-panel">
          <div class="info-item">
            ...
            <div
              class="value a-link"
              v-if="isCurrentUser"
              @click="showPointsRecord"
            >
              {{ userInfo.currentPoints }}
            </div>
            <div v-else class="value">{{ userInfo.currentPoints }}</div>
          </div>
          <div class="info-item">
    ...
    ></UcenterEditUserInfo>
    <!--用户积分记录-->
    <UserPointsRecord ref="ucenterPointsRecordRef"></UserPointsRecord>
  </div>
</template>
...
import UserPointsRecord from "./UserPointsRecord.vue";
...
//获取用户积分记录
const ucenterPointsRecordRef = ref(null);
const showPointsRecord = () => {
  ucenterPointsRecordRef.value.showRecord();
};
